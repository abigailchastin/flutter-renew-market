...
class MyApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return MaterialApp(
      ...
      initialRoute: '/signin', // Halaman pertama saat aplikasi dibuka
      routes: {
        '/signin': (context) => SignInScreen(),
        '/signup': (context) => SignUpScreen(), // Tambahkan ini jika ada SignUpScreen
        '/home': (context) => MyHomePage(title: 'Home Page'), // Pastikan ada HomeScreen
      },
    );
  }
}
